...
const Home: NextPage = () => {
    ...
    if (isLoading)
        return (
            <div className="xs:w-[15rem] sm:w-[28rem] md:w-[36rem] h-auto flex flex-col items-center justify-center">
    ...
    if (fetchedUserInfo && !error)
        return (
            <div className="w-[22rem] sm:w-[22rem] md:w-[36rem] lg:w-[40rem] h-auto flex flex-col items-center justify-center">
                ...
                <motion.pre className="mt-6 text-center xs:text-left text-[1rem] leading-[1.5] text-[#c9d1d9] w-full whitespace-pre-wrap font-default">
                ...
                <p className="text-[#8b949e] text-sm mb-12">
                    ...
                    <a className="no-underline text-[#e35454]" href="https://github.com/zaidmukaddam/sponsor">
                        open source
                    </a>
                    !
                </p>
